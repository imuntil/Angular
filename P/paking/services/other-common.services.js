...
(function () {
    ...
    angular.module('iu.services.otherCommons', [])
        ...
        .factory('iuLocalStorage', iuLocalStorage)
        .factory('Q', Q);
    ...
    function iuLocalStorage($window) {
        ...
        function getValue(key) {
            ...
            try {
                _value = JSON.parse(ls.getItem(key));
            } catch (err) {
                _value = ls.getItem(key);
            }
            return _value;
        }
        function remove(key) {
    ...
    function Q($window) {
        var q = $window.location.search,
            qs = q.length > 0 ? decodeURIComponent(q.substring(1)) : '';
